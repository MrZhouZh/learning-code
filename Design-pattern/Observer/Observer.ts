...
class ConcreteSubject implements Subject {
    ...
    /**
     * @type {Observer[]} List of subscribers. In real life, the list of subscribers can be stored more comprehensively (categorized by event type, etc.).
     */
     ...
     * Subjects commonly hold some important business logic, that triggers a noticfication method whenever something important is about to happen (or after it).
     */
